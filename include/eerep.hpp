...
public:
 ...
 || t == EERecord::Voidcall || t == EERecord::End)
    ...
    EELine(EERecord t, std::string &&p, std::string &&q) : type(t) {
        if (t == EERecord::Decl || t == EERecord::Header) {
            sym[0] = p;
            num = q;
        } else if (t == EERecord::Copy) {
            sym[0] = p;
            sym[1] = q;
        } else if (t == EERecord::Asscall) {
            sym[0] = p;
            sym[1] = q;
        }
    }
    ...
    EELine(EERecord t, std::string &&p, std::string &&q, std::string &&r) : type(t) {
        if (t == EERecord::Unary) {
            ...
            sym[1] = q;
            op = r;
        } else if (t == EERecord::LArr || t == EERecord::RArr) {
            sym[0] = p;
            sym[1] = q;
            sym[2] = r;
        }
    ...
    EELine(EERecord t, std::string &&p, std::string &&q, std::string &&r, std::string &&s) : type(t) {
        if (t == EERecord::Binary) {
            sym[0] = p;
            sym[1] = q;
            sym[2] = r;
            op = s;
        } else if (t == EERecord::Cond) {
            sym[0] = p;
            sym[1] = q;
            op = r;
            label = s;
