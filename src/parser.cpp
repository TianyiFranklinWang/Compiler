...
static const yytype_int8 yyrline[] = {0, 46, 46, 54, 64, 72, 80, 88};
#endif
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
static const yytype_int8 yypact[] = {-3, -36, 1,   -36, -35, -36, -26, -25, -27,
                                     -4, -36, -31, -24, -36, -23, -36, -36};

/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
   Performed when YYTABLE does not specify something else to do.  Zero
   means the default is an error.  */
static const yytype_int8 yydefact[] = {0, 4, 0, 2, 0, 1, 0, 0, 0,
                                       0, 3, 0, 0, 7, 0, 5, 6};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-36, -36, -36, -36, -36, -36, -36};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {0, 2, 3, 4, 10, 12, 14};

/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule whose
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
static const yytype_int8 yytable[] = {1, 5, 6, 7, 9, 8, 11, 13, 15, 0, 0, 16};

static const yytype_int8 yycheck[] = {3,  0,  37, 29, 31, 30,
                                      10, 38, 32, -1, -1, 34};

/* YYSTOS[STATE-NUM] -- The symbol kind of the accessing symbol of
   state STATE-NUM.  */
static const yytype_int8 yystos[] = {0,  3,  40, 41, 42, 0,  37, 29, 30,
                                     31, 43, 10, 44, 38, 45, 32, 34};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] = {0, 39, 40, 41, 42, 43, 44, 45};

/* YYR2[RULE-NUM] -- Number of symbols on the right-hand side of rule RULE-NUM.
 */
static const yytype_int8 yyr2[] = {0, 2, 1, 5, 1, 3, 3, 1};
...
#define YY_SYMBOL_PRINT(Title, Kind, Value, Location)                          \
  do {                                                                         \
    if (yydebug) {                                                             \
      ...
      yy_symbol_print(stderr, Kind, Value, ast);                               \
      YYFPRINTF(stderr, "\n");                                                 \
    }                                                                          \
  } while (0)
...
static void yydestruct(const char *yymsg, yysymbol_kind_t yykind,
                       YYSTYPE *yyvaluep, std::unique_ptr<ast::BaseAST> &ast) {
  YY_USE(yyvaluep);
  YY_USE(ast);
  if (!yymsg)
    yymsg = "Deleting";
...
yyerrlab:
  ...
  if (yyerrstatus == 3) {
    ...
    if (yychar <= YYEOF) {
      ...
      yydestruct("Error: discarding", yytoken, &yylval, ast);
      yychar = YYEMPTY;
    }
  }
...
yyerrlab1:
  ...
  for (;;) {
    ...
    yydestruct("Error: popping", YY_ACCESSING_SYMBOL(yystate), yyvsp, ast);
    YYPOPSTACK(1);
    yystate = *yyssp;
    YY_STACK_PRINT(yyss, yyssp);
  }
...
yyreturnlab:
  if (yychar != YYEMPTY) {
    /* Make sure we have latest lookahead translation.  See comments at
       user semantic actions for why this is necessary.  */
    yytoken = YYTRANSLATE(yychar);
    yydestruct("Cleanup: discarding lookahead", yytoken, &yylval, ast);
  }
  /* Do not reclaim the symbols of the rule whose action triggered
  ...
  YY_STACK_PRINT(yyss, yyssp);
  while (yyssp != yyss) {
    yydestruct("Cleanup: popping", YY_ACCESSING_SYMBOL(+*yyssp), yyvsp, ast);
    YYPOPSTACK(1);
  }
#ifndef yyoverflow
  if (yyss != yyssa)
